...
class EditDashboardAdmin extends StatefulWidget {
  const EditDashboardAdmin({super.key});


  @override
  _EditDashboardAdminState createState() => _EditDashboardAdminState();
}
...
class _EditDashboardAdminState extends State<EditDashboardAdmin> {
  File? _image;
