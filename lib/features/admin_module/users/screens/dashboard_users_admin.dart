...
class _DashboardUsersAdminState extends State<DashboardUsersAdmin> {
  ...
  List<UserListModel> filteredUserList = [];
  ...
  void _onSearchChanged() {
    ...
    setState(() {
      filteredUserList = allUserList.where((user) {
        ...
        final empId = user.empId?.toLowerCase() ?? '';
        return name.contains(query) || email.contains(query) || empId.contains(query);
      }).toList();
    });
  }
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              '${filteredUserList[index].salutation != null ? '${filteredUserList[index].salutation} ' : ''}${filteredUserList[index].name}',
                                            ...
                                            SizedBox(
                                                height: ScreenUtils()
                                                    ...
                                                    0.01),
                                             Text(
                                              'EId: ${filteredUserList[index].empId}',
                                              style: const TextStyle(
                                                fontSize: 16,
                                        ...
                                        PopupMenuButton<int>(
                                          ...
                                          onSelected: (value) {
                                            if (value == 1) {
                                              Navigator.pushNamed(
                                                  context, "/ViewUserAdmin", arguments: filteredUserList[index].id);
                                            }
                                            // else if (value == 2) {
                                            //   Navigator.pushNamed(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(
                                         ...
                                         Text(
                                           filteredUserList[index].email.toString(),
                                          style: const TextStyle(
                                            fontSize: 16,
                                            color: Color(0xFF004d40),
                                              fontFamily: "Poppins"
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        SizedBox(
                                         ...
                                         Text(
                                           filteredUserList[index].phoneNo.toString(),
                                          style: const TextStyle(
                                            fontSize: 16,
                                            color: Color(0xFF004d40),
                                              fontFamily: "Poppins"
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                            width: MediaQuery.of(context)
                                                ...
                                                0.01),
                                         Text(
                                           filteredUserList[index].gender.toString(),
                                          style: const TextStyle(
                                            fontSize: 16,
                                            color: Color(0xFF004d40),
                                              fontFamily: "Poppins"
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Icon(
                                              filteredUserList[index].isActive == 1 ? Icons.check_circle : Icons.cancel,
                                              color: filteredUserList[index].isActive == 1 ? Colors.green : Colors.red,
                                            ),
                                            SizedBox(width: MediaQuery.of(context).size.width * 0.01),
                                            Text(
                                              'Login Status: ${filteredUserList[index].isActive == 1 ? "Active" : "Inactive"}',
                                              style: const TextStyle(
                                                fontSize: 16,
                                        ...
                                        Switch(
                                          value: filteredUserList[index].isActive == 1,
                                          onChanged: (bool newValue) {
                                            setState(() {
                                              filteredUserList[index].isActive = newValue ? 1 : 0;
                                            });
                                            updateActiveStatus(
                                              filteredUserList[index].id ?? 0,
                                              filteredUserList[index].isActive ?? 0,
                                            );
                                                                                   },
